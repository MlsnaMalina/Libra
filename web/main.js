(function () {
  ...
  var EN = {
    ...
    'hero.h1c': 'technology',
    'hero.lede': 'Where lawyers meet AI. Nine years in legal practice, seven years as a book editor at Wolters Kluwer, two years building with AI. The ideal combination for a Legal Engineer role.',
    ...
    'three.w2.body': 'Seven years as an in-house book editor at Wolters Kluwer ČR, plus two more as an external editor. Spotting where a sentence does not sit right, where an author still cites a repealed statute. Translating the law into something readable. 71 published professional books in the legal division.',
    'three.w2.t1': 'Editing',
    ...
    'three.w3.body': 'A relentless interest in technology, vibe coding. Personal website, learning games, legal checklists, calculators. Builder mindset, not just an interest in AI.',
    ...
    'path.m2.desc': 'Including a semester on the Global Economy & Law Program at the University of Haifa, Israel (2013).',
    'path.m3.dur': '9 years',
    'path.m3.s1.dur': 'Small firm',
    'path.m3.s1.cat': 'Practice · Office back',
    ...
    'path.m3.s2.cat': 'Practice · Office back',
    ...
    'path.m3.s3.cat': 'Practice · Office back',
    ...
    'path.m3.s4.cat': 'Practice · Office back',
    'path.m3.s4.title': 'Brodec & partners, law firm',
    'path.m3.s4.desc': 'A managing partner, 2 lawyers, 3 trainees and 2 law students.',
    'path.m3.s5.dur': 'Trainee',
    'path.m3.s5.cat': 'Practice · Trainee',
    'path.m3.s5.title': 'Hrudka & Partners',
    'path.m3.s5.desc': 'A large firm — 3 partners, 5 lawyers, 3 trainees, 3 law students and 4 administrative staff. General practice, liquidators and insolvency administrators, criminal law.',
    ...
    'path.m4.desc': 'Editor in the legal division, focused on financial law, IT law, intellectual property and civil procedure. Manuscript processing (content and formal review), communication with authors and vendors, and the administration of the publishing workflow.',
    'path.m5.dur': 'present',
    'path.m5.cat': 'Builder',
