(function () {
  ...
  var EN = {
    ...
    'path.m4.desc': 'Editor in the legal division, focused on financial law, IT law, intellectual property and civil procedure. Manuscript processing (content and formal review), communication with authors and external vendors (proof-reader, typesetter, printer), and the administration of the publishing workflow. Beyond book manuscripts I also produce navigators (visual / technical guides that walk lawyers through a specific procedure on a specific topic).',
    'path.m5.dur': 'present',
    'path.m5.cat': 'Builder',
    ...
    'path.m5.b2.val': 'AI First, Anthropic, various webinars',

    'proj.kicker': '04 — AI Projects',
    'proj.title': 'Current projects',
    'proj.lede': 'Five projects from this year.',
    'proj.open': 'Open →',
    'proj.p1.cat': 'Interactive tool', 'proj.p1.status': 'password-protected',
    'proj.p1.scrollHint': '↓ scroll for full-page preview',
    'proj.p1.title': 'Reprint checklist',
    'proj.p1.desc': 'An interactive checklist for editors to handle the administrative work around ordering reprints.',
    'proj.p1.b1': 'tracks the delivery dates of books from the printer,',
    'proj.p1.b2': 'tracks the deadline for entering the reprint into Navision / the editorial plan and offers to add it to the Outlook calendar,',
    'proj.p1.b3': 'generates an email with the key information about the reprint for colleagues in Accounting and Customer Service,',
    'proj.p1.b4': 'records progress in steps and percentages,',
    'proj.p1.b5': 'lets you download the information to disk or print it,',
    'proj.p1.b6': 'is password-protected.',
    'proj.p1.t1': 'JS', 'proj.p1.t2': 'PDF export', 'proj.p1.t3': 'Auth',
    'proj.p2.cat': 'Game', 'proj.p2.status': 'live',
    'proj.p2.title': 'Ignorance of good books is no excuse',
    'proj.p2.desc': 'An interactive Hangman-style game for lawyers — during a break at the Legal Innovation Day conference they can discover, in a playful way, every IT law book Wolters Kluwer ČR has published.',
    'proj.p2.t1': 'JS', 'proj.p2.t2': 'Game', 'proj.p2.t3': 'WK IT',
    'proj.p3.cat': 'Portfolio', 'proj.p3.status': 'live',
    'proj.p3.title': 'Personal website',
    'proj.p3.desc': 'My personal site katerinamlsnova.cz. Built through vibe coding — static HTML/CSS on GitHub Pages. No backend, no cookies. Proof that a lawyer without a CS background can ship a product with AI.',
    'proj.p3.t1': 'HTML', 'proj.p3.t2': 'CSS', 'proj.p3.t3': 'Claude Code',
    'proj.p4.cat': 'Edu', 'proj.p4.status': 'beta',
    ...
    'proj.p5.t1': 'JavaScript', 'proj.p5.t2': 'CSV',
